...
<template>
  <div class="flex flex-col sub-app-container w-full lg:w-80">
   ...
   <!-- add new project button -->
    <div class="fixed bottom-24 left-1/2 transform -translate-x-1/2 z-45 w-4/5 lg:w-72">
      <button
        ...
        class="flex justify-center button button-large text-white rounded-full p-4 w-full shadow-lg"
      >
        <IconPlus />
        &nbsp;New Project
      </button>
...
/*fetch the projects.json file using the fetch API on App load. 
  Set the projects array in the pinia store.
*/
onMounted(() => { 
  fetch('/src/api/projects.json')
