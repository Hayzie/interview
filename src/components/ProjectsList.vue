...
<template>
    <!-- projects list -->
    <div class="flex project-list overscroll-none flex-wrap justify-center mt-4 mb-0 ml-auto mr-auto w-full md:w-80 lg:ml-2 overflow-hidden lg:justify-normal lg:w-80">
        <div v-for="project in filteredProjects" :key="project.id" class="bg-white zoom-in w-36 m-1 border-gray-300 py-2 rounded-lg overflow-hidden card mb-4">
          <div class="px-4">
